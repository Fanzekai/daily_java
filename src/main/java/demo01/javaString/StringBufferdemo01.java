...
import demo01.DateDemo.UnsafeSimpleDateFormatDemo01;
...
public class StringBufferdemo01 {
    ...
    private static final Logger log = LogManager.getLogger(StringBufferdemo01.class);
    ...
    public static void main(String[] args) {
        ...
        s1.append("Java");//在字符串s1的末尾添加字符串"J修改后的字符串s1为ava"
        log.info("修改后的字符串s1为：" + s1);
        log.info("-----------------------------------------------------");
